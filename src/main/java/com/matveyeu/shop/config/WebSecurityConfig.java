package com.matveyeu.shop.config;

import com.matveyeu.shop.repository.UserRepository;
import com.matveyeu.shop.service.impl.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) {
        web.ignoring().antMatchers("/webjars/**", "/static/js/**","/error/**"
                , "/static/images/css/**","/fonts/**","/libs/**","/img/**","/h2-console/**");
    }
